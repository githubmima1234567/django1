...
class taobao(unittest.TestCase):
    ...
    # 读取js文件
    with open("taobao+selenium/taobao.js", 'r') as f:
        js_code1 = f.read()
    ...
    print(response)
    # 保存response文件
    with open("taobao+selenium/baotao.txt", "wb") as f:
        f.write(response.content)
 #
 # headers: {
 #                        Authorization: l,
 #                        "x-page-code": document.pageCode,
 #                        "x-page-url": document.pathUrl,
 #                        "x-auth-sign": (0,
 #                        s.default)(JSON.stringify(t) + "ETC-PARTS-KEY")
 #                    },