...
#
                ...
                try:
                    for i in range(1,num+1):
                        ...
                        data = {}
                        time.sleep(2)
                        # chexing = html1.xpath("//div[@class='list-body']/div[1]/div/div/div/div/div/div/div/span/span")
                        # print("车型："+str(chexing[0].string))
                        # print(chexing)
                        # 点击ETC号
                        ETC_btn = self.driver.find_element(By.XPATH,"//div[@class='list-body']/div[%d]/div/div/div/div/div/div/span[@class='e-text-link']" %i)
                        self.driver.execute_script("arguments[0].click();", ETC_btn)
                        #切换到最新商品详情窗口
